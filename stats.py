...
if __name__ == '__main__':
	st = stats()
	fs = [todas, media, varianza, forma, indep]
	...
	cn = int(input("Entre la cantidad de numeros: (5 ≤ c < 30) "))
	al = float(input("Entre el valor de alpha: (0.1 ó 0.05) "))
	fl = input('Entre el nombre de archivo para guardar los resultados o deje en blanco para escribirlos en la pantalla: ')
	
	if 1 <= option < 6 and (al == 0.1 or al == 0.05) and (5 <= cn < 30):
		...
		print('Argumentos no válidos', file=sys.stderr)
